  ...
  <main class="flex min-h-screen items-center justify-center bg-[#f3f5fb] px-4 py-8">
    <section class="w-full max-w-md rounded-3xl border border-slate-200/60 bg-white p-8 shadow-xl shadow-slate-200/50">
      <div class="mb-8 text-center">
        ...
        <h1 class="mt-4 text-2xl font-extrabold text-slate-900">Selamat Datang 👋</h1>
      ...
      <div class="mt-8 text-center text-sm text-slate-500">
        Belum memiliki akun?
        <router-link to="/register" class="font-bold text-primary transition hover:text-primary-dark hover:underline">
          Daftar Sekarang
        </router-link>
      </div>
    </section>
